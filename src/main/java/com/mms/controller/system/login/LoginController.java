package com.mms.controller.system.login;
...
import com.mms.service.erp.customer.CustomerManager;
import com.mms.service.erp.intoku.IntoKuManager;
...
import com.mms.entity.system.User;
...
import com.mms.util.DateUtil;
import com.mms.util.Jurisdiction;
import com.mms.util.PageData;
import com.mms.util.RightsHelper;
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("fh", "").replaceAll("QQ978336446fh", "").split(",fh,");
