package com.mms.controller.fhdb.timingbackup;
...
import com.mms.util.QuartzManager;
import com.mms.util.Tools;
import com.mms.service.fhdb.timingbackup.TimingBackUpManager;
...
public class TimingBackUpController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		String TIME = pd.getString("TIME");									//时间规则
		...
		this.addJob(JOBNAME, TIME, TABLENAME,TIMINGBACKUP_ID);				//添加任务
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var5", varOList.get(i).getString("TIME"));	//5
	 ...
	 */
	public void addJob(String JOBNAME, String TIME, String TABLENAME, String TIMINGBACKUP_ID){
		Map<String,Object> parameter = new HashMap<String,Object>();
		parameter.put("TABLENAME", TABLENAME);
		parameter.put("TIMINGBACKUP_ID", TIMINGBACKUP_ID);
		QuartzManager.addJob(JOBNAME,JOB_GROUP_NAME, JOBNAME, TRIGGER_GROUP_NAME, DbBackupQuartzJob.class, TIME ,parameter); 
	}
